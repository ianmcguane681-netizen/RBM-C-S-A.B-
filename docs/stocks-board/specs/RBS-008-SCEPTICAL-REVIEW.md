...
This seat asks what the board has NOT established, and whether the gates that were
answered are the gates that matter for this subject.

---

## 2. Scope

Everything in scope for the review, and specifically everything a reader might
believe the review covered that it did not.
...
This seat is additionally blind to the proposed outcome: it is told what was examined
and not what the board is minded to conclude, because a reviewer who knows the
intended answer reviews toward it.

---

## 4. Audit Procedure

Reports after the specialists and before the Methodology Auditor.

---

## 5. Evidence Standards

The same standards as every other seat. This seat raises no figure it cannot cite.

---

## 6. Finding Classification Guidance

The characteristic finding of this seat is that every gate passed and the question a
holder actually faces was never in scope. That is SEV-2 where a reader would take
the result as an assessment of the subject.
