# Reviewer Specification: Control and Related-party Analyst
...
**Reviewer Role:** Control and Related-party Analyst (CRA)
...
This seat answers SG-04 — Control and related parties — and nothing else. Its findings cite
`RBS-005 section 7 (SG-04)`, so a reader moves from a finding to the seat that
...
Identify every holder of disproportionate voting power, every class of share and its rights, and material related-party transactions. A claim of dispersed ownership must be verified against the filings that report control.
...
**The failure mode this seat exists for.** A company is described as widely held while a founder retains supervoting shares that decide every vote.
