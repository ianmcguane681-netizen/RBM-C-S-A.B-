...
**1426 tests, 2 skipped.** Two things live here: the **review board engine** (the original
...
| **verification** | `verify.py` proves each credential with a real call and keeps a rejected key apart from an unreachable service; costs no quota, places nothing | — |
